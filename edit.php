...
<h3>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;แสดงข้อมูลอนิเมะ</h3>

<div class="container">
  <table  class="table table-condensed" >
   <thead bgcolor="#4682B4" >
  <tr bgcolor="#4682B4">
	<td  align="center"  width="8%" ><font color="CCE1FF"><b>รหัสอนิเมะ </b></font></td>
	<td align="center"  width="13%"><font color="CCE1FF"><b>ชื่ออนิเมะ </b></font></td>
	<td align="center"  width="10%"><font color="CCE1FF"><b>ประเภท </b></font></td>
	<td align="center"  width="30%"><font color="CCE1FF"><b>เรื่องย่อ </b></font></td>
	<td align="center"  width="10%"><font color="CCE1FF"><b>ค่าย </b></font></td>
		<td align="center"  width="8%"><font color="CCE1FF"><b>ปี </b></font></td>
		<td align="center"  width="10%"><font color="CCE1FF"><b>แก้ไข </b></font></td>
		<td align="center"  width="15%"><font color="CCE1FF"><b>ลบข้อมูล</b></font></td>
  </tr>
     <tbody>
...
while ($num_rows=mysqli_fetch_assoc($result_sql))
{
	...
	<tr>
		...
		<td align='center'><a href="edit_show.php?anm_id=<?php echo $num_rows["anm_id"];?>">แก้ไข</a></td>
		<td align="center"><a href="JavaScript:if(confirm('ยืนยันการลบข้อมูล !') == true){window.location='delete.php?anm_id=<?php echo $num_rows["anm_id"];?>';}">ลบข้อมูล</a></td>
		</tr>
<?php
	$i++;
}
