...
<nav class="navbar navbar-default navbar-fixed-top bg-3 ">
 ...
 <?php 
	 ...
	 $sql="SET NAMES utf8" ; 
	 $abc->query($sql);
	 $strSQL="DELETE from table_anime WHERE anm_id='".$_GET["anm_id"]."'";
	 $result=$abc->query($strSQL);
	 if ($result)
		{echo "<br><br><br><br><center>ลบข้อมูลสำเร็จ</center>";}
	else
		{echo "<br><br><br><br><center>ลบข้อมูลไม่สำเร็จ ! [".$strSQL."]</center>";}
